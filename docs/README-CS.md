<p align="center">
  <img src="../res/logo-header.svg" alt="QuinyxDesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">uživatelského rozhraní aplikace QuinyxDesk</a> a <a href="https://github.com/rustdesk/doc.rustdesk.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
[![QuinyxDesk Server Pro](https://img.shields.io/badge/QuinyxDesk%20Server%20Pro-Pokro%C4%8Dil%C3%A9%20Funkce-blue)](https://rustdesk.com/pricing.html)
...
Projekt QuinyxDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak QuinyxDesk funguje?**](https://github.com/rustdesk/rustdesk/wiki/How-does-QuinyxDesk-work%3F)
