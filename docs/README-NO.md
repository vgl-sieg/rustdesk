<p align="center">
  ...
  <b>Vi trenger din hjelp til å oversette denne README-en, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">QuinyxDesk UI</a> og <a href="https://github.com/rustdesk/doc.rustdesk.com">QuinyxDesk Doc</a> tid ditt morsmål</b>
</p>
...
[![QuinyxDesk Server Pro](https://img.shields.io/badge/QuinyxDesk%20Server%20Pro-Avanserte%20Funksjoner-blue)](https://rustdesk.com/pricing.html)
...
QuinyxDesk er velkommen for bidrag fra alle. Se [CONTRIBUTING.md](CONTRIBUTING-NO.md) for hjelp med oppstart.
...
Venligst pass på att du kjører disse kommandoene fra roten av QuinyxDesk repositoret, eller kan det hende att applikasjon ikke finner de riktige ressursene. Pass også på att andre cargo subkommandoer som for eksempel `install` eller `run` ikke støttes med denne metoden da de vill installere eller kjøre programmet i konteineren istedet for verten.
